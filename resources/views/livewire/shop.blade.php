...
{{--        <div class="col-span-5 md:col-span-2 lg:col-span-2">--}}
        <div class="col-span-5 md:col-span-2 lg:col-span-2 flex flex-col">
            <x-label for="genre" value="Genre"/>
{{--            <x-tmk.form.select id="genre" class="block mt-1 w-full">--}}
            <x-tmk.form.select id="genre" wire:model.live="genre" class="block mt-1 w-full">
...
{{--        <div class="col-span-5 md:col-span-3 lg:col-span-2">--}}
        <div class="col-span-5 md:col-span-3 lg:col-span-2 flex flex-col">
            <x-label for="perPage" value="Records per page"/>
{{--            <x-tmk.form.select id="perPage" class="block mt-1 w-full">--}}
            <x-tmk.form.select id="perPage" wire:model.live="perPage" class="block mt-1 w-full flex-1">
